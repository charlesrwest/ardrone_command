...
case SET_CLEAR_COMMAND_QUEUE:
return "SET_CLEAR_COMMAND_QUEUE";
break;

case SET_EMERGENCY_LANDING_COMMAND:
return "SET_EMERGENCY_LANDING_COMMAND";
break;

case SET_EMERGENCY_STOP_COMMAND:
return "SET_EMERGENCY_STOP_COMMAND";
break;

case SET_TAKEOFF_COMMAND:
return "SET_TAKEOFF_COMMAND";
break;

case SET_LANDING_COMMAND:
return "SET_LANDING_COMMAND";
break;

case SET_CONTROL_SHUTDOWN_COMMAND:
return "SET_CONTROL_SHUTDOWN_COMMAND";
break;

case SET_TARGET_ALTITUDE_COMMAND:
return "SET_TARGET_ALTITUDE_COMMAND";
break;

case SET_HORIZONTAL_HEADING_COMMAND:
return "SET_HORIZONTAL_HEADING_COMMAND";
break;

case SET_ANGULAR_VELOCITY_COMMAND:
return "SET_ANGULAR_VELOCITY_COMMAND";
break;

case SET_FLIGHT_ANIMATION_COMMAND:
return "SET_FLIGHT_ANIMATION_COMMAND";
break;

case SET_LED_ANIMATION_COMMAND:
return "SET_LED_ANIMATION_COMMAND";
break;

case SET_MAINTAIN_POSITION_AT_SPECIFIC_QR_CODE_POINT:
return "SET_MAINTAIN_POSITION_AT_SPECIFIC_QR_CODE_POINT";
break;

case SET_CANCEL_MAINTAIN_POSITION_AT_SPECIFIC_QR_CODE_POINT:
return "SET_CANCEL_MAINTAIN_POSITION_AT_SPECIFIC_QR_CODE_POINT";
break;

case SET_MAINTAIN_ORIENTATION_TOWARD_SPECIFIC_QR_CODE:
return "SET_MAINTAIN_ORIENTATION_TOWARD_SPECIFIC_QR_CODE";
break;

case SET_CANCEL_MAINTAIN_ORIENTATION_TOWARD_SPECIFIC_QR_CODE:
return "SET_CANCEL_MAINTAIN_ORIENTATION_TOWARD_SPECIFIC_QR_CODE";
break;

case SET_WAIT_COMMAND:
return "SET_WAIT_COMMAND";
break;

case SET_WAIT_UNTIL_TAG_IS_SPOTTED_COMMAND:
return "SET_WAIT_UNTIL_TAG_IS_SPOTTED_COMMAND";
break;

case SET_WAIT_UNTIL_SPECIFIC_QR_CODE_IS_SPOTTED_COMMAND:
return "SET_WAIT_UNTIL_SPECIFIC_QR_CODE_IS_SPOTTED_COMMAND";
break;

case SET_WAIT_UNTIL_POSITION_AT_SPECIFIC_QR_CODE_POINT_REACHED:
return "SET_WAIT_UNTIL_POSITION_AT_SPECIFIC_QR_CODE_POINT_REACHED";
break;

case SET_WAIT_UNTIL_ALTITUDE_REACHED:
return "SET_WAIT_UNTIL_ALTITUDE_REACHED";
break;
}
