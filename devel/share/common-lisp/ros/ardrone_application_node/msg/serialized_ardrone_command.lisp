...
(cl:defclass <serialized_ardrone_command> (roslisp-msg-protocol:ros-message)
  ((command
    :reader command
    :initarg :command
    :type ardrone_application_node-msg:serialized_ardrone_command_part
    :initform (cl:make-instance 'ardrone_application_node-msg:serialized_ardrone_command_part))
   (subcommands
    :reader subcommands
    :initarg :subcommands
    :type (cl:vector ardrone_application_node-msg:serialized_ardrone_command_part)
   :initform (cl:make-array 0 :element-type 'ardrone_application_node-msg:serialized_ardrone_command_part :initial-element (cl:make-instance 'ardrone_application_node-msg:serialized_ardrone_command_part))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <serialized_ardrone_command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'serialized_ardrone_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ardrone_application_node-msg:<serialized_ardrone_command> is deprecated: use ardrone_application_node-msg:serialized_ardrone_command instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <serialized_ardrone_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ardrone_application_node-msg:command-val is deprecated.  Use ardrone_application_node-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'subcommands-val :lambda-list '(m))
(cl:defmethod subcommands-val ((m <serialized_ardrone_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ardrone_application_node-msg:subcommands-val is deprecated.  Use ardrone_application_node-msg:subcommands instead.")
  (subcommands m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <serialized_ardrone_command>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'subcommands)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ardrone_application_node-msg:serialized_ardrone_command_part))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<serialized_ardrone_command>)))
  ...
  "ardrone_application_node/serialized_ardrone_command")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'serialized_ardrone_command)))
  "Returns string type for a message object of type 'serialized_ardrone_command"
  "ardrone_application_node/serialized_ardrone_command")
