...
*/
void setWaitUntilPositionAtSpecificQRCodePointReachedCommand(double inputNumberOfSeconds, double inputTargetDistance = .4, double inputMaximumSpeed = 300.0); //Go back to 30 at some point?
